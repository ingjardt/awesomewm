...
revelation.init()
beautiful.wallpaper = "/home/ingjard/.wallpaper/wallpaper.png"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({modkey,           },"bar" , revelation,
              {description="Revelation", group="Ingjard"} 
              ),
    awful.key({modkey,           },"Delete" , function () awful.spawn("gnome-screensaver-command --lock" ) end,
              {description="Lock Screen", group="Ingjard"} 
              ),
    ...
    awful.key({ modkey,           }, "t",      
        function (c) 
            ...
            c.sticky = not c.sticky            
              ...
              {description = "Turn into Widget: toggle keep on top,sticky and float", group = "client"}),
    awful.key({ modkey,           }, "n",
        function (c)
